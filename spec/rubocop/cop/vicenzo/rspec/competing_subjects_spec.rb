  ...
  describe 'offense detection' do
    context 'when two definitions are each asserted on' do
      it 'registers an offense on the group' do
        post_offense = 'The expectations here are about `:reviewed_post`, `:draft_post`, so this group has no one ' \
                       'subject. Work out what these definitions are to it, and let the structure say so.'
