...
RSpec.describe RuboCop::Cop::Vicenzo::RSpec::SubjectIsMethodResult, :rspec_config do
  describe 'offense detection' do
    context 'when the example group describes an instance method' do
      context 'and the subject invokes it on a new instance' do
        it 'registers an offense' do
          catch_offense = 'Subject holds what `catch` returned, not the object under test. Make the subject the ' \
                          'object that receives `catch`, and call it inside the example.'
    ...
    context 'when the description is a bare method name' do
      it 'registers an offense' do
        catch_offense = 'Subject holds what `catch` returned, not the object under test. Make the subject the object ' \
                        'that receives `catch`, and call it inside the example.'
